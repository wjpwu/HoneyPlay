...
//        return "data:" + MimeTypes.getMimeType(image.getName()) + ";base64," + Codec.encodeBASE64(IO.Read(image));
//    }
...
*/
        ...
        public ByteArrayInputStream toArray()
        {
        	check();
        	return bais;
        }
        ...
        void check() {
            try {
                if (bais == null) {
                    ...
                    //
                    play.mvc.Http.Context.current().response().setContentType("image/png");
                }
            } catch (Exception e) {
