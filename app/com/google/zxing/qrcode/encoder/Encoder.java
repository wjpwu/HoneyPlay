...
public final class Encoder {
  ...
  public static QRCode encode(String content,
    ...
    // set min version
    if(hints.get(EncodeHintType.MIN_VERFSION) != null)
    {
    	int versionNumber = Integer.parseInt(hints.get(EncodeHintType.MIN_VERFSION).toString());
    	if(version.getVersionNumber() < versionNumber && versionNumber <=40)
